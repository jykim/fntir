...
\begin{enumerate}
	...
	\item In order to make behavioral data more valuable, find ways to build a user model so that the data can be reused for another purposes.
\end{enumerate}
