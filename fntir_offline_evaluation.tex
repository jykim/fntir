...
%One way to think about this is that absolute judgment is like using between-subject experiment design (one label per experimental setting), whereas relative judgment can be linked to within-subject experiment design.
