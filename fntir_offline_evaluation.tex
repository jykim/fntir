...
\section{Determining Judging Target}
...
Judging target defines the basic unit and type of judgment. Judging unit would be determined by the goal of evaluation.

%, and can be a document, SERP elements or a whole SERP.
...
\newpar
Judging Context: how to explain context?

- Webpage \cite{Golbus:2014:CDR}

- Session context \cite{Mao:2016}
