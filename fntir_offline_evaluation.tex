...
The test collection approach extends this model to incorporate judgements and metrics (Figure~\ref{fig:ir-with-judges}). The query, document collection

\paul{to write past here}

in theory complete; in practice not---pooling; documents fixed

judgements reusable, systems and topics comparable
...
- TREC and related evaluation venues

- Refer to \cite{borlund2003}
