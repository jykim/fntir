...
The most common approach for evaluating the quality of retrieval systems is the test collection methodology. Forming a test collection typically involves three stages: (1) assembling a document collection, (2) creating a set of information needs (topics) and (3) identifying the set of documents relevant to the topics. We will now describe each one of these stages, the assumptions behind them, and the methods used during each stage. Below we provide a summary of the common mechanisms used in each of these stages. 
...
\cite{borlund2003}. Recent Morgan and Claypool(?) from Tefko.
